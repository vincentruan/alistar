<template>
  <div class="app-container">
    <div class="block">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-input v-model="listQuery.cfgName" size="mini" :placeholder="$t('config.name')" />
        </el-col>
        <el-col :span="6">
          <el-input v-model="listQuery.cfgValue" size="mini" :placeholder="$t('config.value')" />
        </el-col>
        <el-col :span="6">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('config.name')" prop="cfgName">
              <el-input v-model="form.cfgName" minlength="1" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :label="$t('config.value')" prop="cfgValue">
              <el-input v-model="form.cfgValue" minlength="1" />
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item :label="$t('config.descript')" prop="cfgDesc">
              <el-input v-model="form.cfgDesc" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item>
